...
<form action="/dream/contact/save/{{$company['id']}}">
<div class="content"><i class="big blue edit icon"></i>往来单位 — 编辑 </div>
<hr>
<br/>
<div id=con>
  <ul id=tags>
...
<br/>
    <div class="two fields">
        <div class="inline field">
          <label>单位编码:</label>
          <input name="id" type="text" readonly placeholder="自动编码" value="{{$company['id']}}" style="width: 300px;">
        </div>
        <div class="inline field">
          <label>单位名称:</label>
    ...
    <br/>
        <div class="two fields">
            ...
            <div class="inline field">
              <label>职务:</label>
              <input name="create_time" type="text" readonly="" style="width: 300px;">
            </div>
        </div>
        <div class="two fields">
            <div class="inline field">
        ...
        <div class="field">
            <div class="inline field">
              <label>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注:</label>
              <input name="disable_person" type="text" readonly="" style="width: 750px;">
            </div>
        </div>
<br/>
    </div>
    ...
    <br/>
        <div class="two fields">
            <div class="inline field">
              <label>分管部门:</label>
              <input name="c_department" type="text" value="{{$company['c_department']}}" style="width: 300px;">
            </div>
            <div class="inline field">
              <label>业&nbsp;&nbsp;务&nbsp;&nbsp;员:&nbsp;</label>
              <input name="salesmen" type="text" value="{{$company['salesmen']}}" style="width: 300px;">
            </div>
        </div>
        <div class="two fields">
            <div class="inline field">
              <label>税&nbsp;&nbsp;&nbsp;率&nbsp;&nbsp;&nbsp;%:</label>
              <input name="tax" type="text" value="{{$company['tax']}}" style="width: 300px;">
            </div>
            <div class="inline field">
              <label>税&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:&nbsp;</label>
              <input name="t_number" type="text" value="{{$company['t_number']}}" style="width: 300px;">
            </div>
        </div>
        <div class="two fields">
            <div class="inline field">
              <label>开&nbsp;&nbsp;户&nbsp;&nbsp;行:&nbsp;</label>
              <input name="bank" type="text" value="{{$company['bank']}}" style="width: 300px;">
            </div>
            <div class="inline field">
              <label>银行账号:</label>
              <input name="b_number" type="text" value="{{$company['b_number']}}" style="width: 300px;">
            </div>
        </div>
       <div class="two fields">
            <div class="inline field">
              <label>折扣率&nbsp;%:</label>
              <input name="discount" type="text" value="{{$company['discount']}}" style="width: 300px;">
            </div>
            <div class="inline field">
              <label>信用额度:</label>
              <input name="creadit" type="text" value="{{$company['credit']}}" style="width: 300px;">
            </div>
        </div>
        <div class="two fields">
            <div class="inline field">
        ...
        <div class="two fields">
            ...
            <div class="inline field">
              <label>停用时间:</label>
              <input name="stop_time" type="text" readonly=""value="{{$company['stop_time']}}" style="width: 300px;">
            </div>
        </div>
<br/>
    </div>
