...
<form action="/dream/setting/save/{{$person['id']}}">
<div class="content"><i class="big blue edit icon"></i>部门设置 — 编辑 </div>
<hr>
<div id=con>
  <ul id=tags>
...
<br/>
    <div class="two fields">
        <div class="inline field">
          <label>部门编码:</label>
          <input name="number" type="text" readonly placeholder="自动编码" value="{{$person['id']}}" style="width: 300px;">
        </div>
        <div class="inline field">
          <label>部门名称:</label>
          <input name="name" type="text" value="{{$person['name']}}" style="width: 300px;">
        </div>
    </div>
    <div class="two fields">
        <div class="inline field">
          <label>上级部门:</label>
          <input name="higher" type="text" value="{{$person['higher']}}" style="width: 300px;">
        </div>
        <div class="inline field">
          <label>&nbsp;助&nbsp;&nbsp;记&nbsp;&nbsp;码:</label>
    ...
    <div class="two fields">
        ...
        <div class="inline field">
          <label>&nbsp;负&nbsp;&nbsp;责&nbsp;&nbsp;人:</label>
          <input name="charge" type="text" value="{{$person['charge']}}" style="width: 300px;">
        </div>
    </div>
    <div class="two fields">
        <div class="inline field">
          <label>&nbsp;电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话:</label>
          <input name="phone" type="text" value="{{$person['phone']}}" style="width: 300px;">
        </div>
        <div class="inline field">
          <label>&nbsp;传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真:</label>
          <input name="fax" type="text" value="{{$person['fax']}}" style="width: 300px;">
        </div>
    </div>
    <div class="field">
    <div class="inline field">
      <label>&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注&nbsp;:</label>
      <input name="remark" type="text" value="{{$person['note']}}" style="width: 704px;">
    </div>
    <br/>
    </div>
</div>
